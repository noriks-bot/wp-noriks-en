  ...
  <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="" src="https://noriks.com/en/wp-content/uploads/2026/01/starter-1_GR.png">
      </div>
    </div>
...
PROČ LIDÉ VOLÍ STARTOVACÍ BALÍČEK?
    ...
    line-height: 1.2;"  ><strong>"Το υλικό και η εφαρμογή με έπεισαν."
        ...
        <p class="description">The t-shirt and boxers are soft, lightweight, and pleasant on the skin. The starter pack is the most common reason why NORIKS quickly becomes part of the daily wardrobe.
...
<section style="background: white;" class="why-section">
   <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
           <img style="" src="https://noriks.com/en/wp-content/uploads/2026/01/starter-2_gr.png">
      </div>
    </div>
...
ΣΥΝΔΥΑΣΜΟΣ ΠΟΥ ΦΟΡΑΙΣ ΚΑΘΕ ΜΕΡΑ
      ...
      <div style="margin-left: 20px;" class="why-point">
        ...
        <p class="description">The t-shirt and boxers are made to be worn from morning to evening, without adjustments and discomfort. Everything stays in place, does not tighten, and allows free movement all day.
      ...
      <div style="margin-left: 20px;" class="why-point">
        ...
        <p class="description">The t-shirt fit highlights the upper body, while the boxers provide enough room and stability without riding up. The result is a confident, relaxed feeling and polished appearance for any occasion.
...
<section class="why-section">
   <div style="max-width: 1440px;" class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="" src="https://noriks.com/en/wp-content/uploads/2026/01/starter-3_gr.png">
      </div>
    </div>
...
THE EASIEST AND SAFEST START
      ...
      <div style="margin-left: 20px;" class="why-point">
        ...
        <p class="description">Because it allows you to experience the quality without a big investment. Instead of buying many pieces upfront, you get one t-shirt and one boxer - just enough to see how they fit, how they wear, and what the material is like.

</p>
      </div>

      <div style="margin-left: 20px;" class="why-point">
        <p><strong>The perfect way to start


</strong></p>
        <p class="description">The starter pack was created as a first experience, not as stock. It is available only once per customer at a special price, so the decision is simple and without second thoughts.
      ...
      <div style="margin-left: 20px;" class="why-point">
        <p><strong>An experience you come back to


</strong></p>
        <p class="description">Most men stay with NORIKS because they recognize the difference in fit, comfort, and quality. But the first step is exactly that - minimal risk, clear impression.
</p>
      </div>
    </div>
    ...
    <div class="why-col">
      <div class="video-wrapper">
        <video
          ...
          class="why-video">
          <source src="https://noriks.com/en/wp-content/uploads/2025/09/noriks_gif_gr_2-1.mp4" type="video/mp4">
  ...
  <div class="container why-container">
    ...
    <div class="why-col">
      <div class="video-wrapper">
          <img style="width: 100%;
    aspect-ratio: 1/1;
    object-fit: cover;  " src="/en/wp-content/themes/noriks/img/majice-3 (1).jpeg">
      </div>
    </div>
...
<section  style="background: white;" class="why-section">
  <div class="container why-container">
    ...
    <!-- Left Video -->
    <div class="why-col">
       <img src="https://noriks.com/en/wp-content/uploads/2026/01/prednosti-in-lastnosti2_gr.png">
    </div>
