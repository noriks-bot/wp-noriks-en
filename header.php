...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Formatter for USD with 2 decimals
  ...
  function formatPrice(amount) {
    ...
    return usd.format(Math.round(amount * 100) / 100);
  }
...
<div id="page" class="hfeed site">
  ...
  <div class="marquee">
    <div class="marquee-content">
      ...
      <span><a href="/en/shop">30 days risk-free – try without worry</a></span>
      <!--<span><a href="/en/shop">Winter sale: Up to 70% off!</a></span>-->
        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/en/shop">Build Your Pack</a>
                        <a href="/en/product-category/tricka/">Ready Packs</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/en/product-category/boxerky-sastavi-paket/">Build Your Pack</a>
                        <a href="/en/product-category/boxerky/">Ready Packs</a>
                    </div>
                    -->
                </div>
