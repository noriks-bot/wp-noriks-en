...
get_header(); ?>
  ...
  <div class="hero__media" aria-hidden="true">
    ...
    <img
      src="/en/wp-content/themes/noriks/img/noriks-hero.jpeg"
      alt=""
    />
  </div>
  ...
  <div class="hero__content">
    ...
    <a class="hero__btn" href="/en/shop">BUY NOW</a>
  </div>
</section>
...
@media (max-width: 640px) {
  ...
  <div class="collections__grid">
    <!-- Card 1 -->
    <a class="collection-card" href="/en/shop/?filter_product_cat=t-shirts">
      <div class="collection-card__media">
        <img
          src="/en/wp-content/themes/noriks/img/noriks-majice.jpeg"
...
All-day comfort. No riding up.
    ...
    <!-- Card 2 -->
    <a class="collection-card" href="/en/shop/?filter_product_cat=boxers">
      <div class="collection-card__media">
        <img
          src="/en/wp-content/themes/noriks/img/noriks-boksarice.jpeg"
          alt="V-neck t-shirt"
        />
      </div>
   ...
   Soft. Breathable. Reliable.
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="/en/product-category/bundles/">
      <div class="collection-card__media">
        <img
          src="/en/wp-content/themes/noriks/img/noriks-kompleti.jpeg"
...
Best value for money in a set.
    ...
    <!-- Card 4 - Starter Pack -->
    <a class="collection-card" href="/en/shop/?filter_product_cat=starter-pack">
      <div class="collection-card__media">
        <img
          src="/en/wp-content/themes/noriks/img/starter-paket_.jpeg"
          alt="Long sleeve shirt"
        />
      </div>
