<?php
/**
 * NORIKS EN — deljen blok ocen in socialnega dokaza (vsi izdelki)
 *
...
<?php 
  ...
  function get_review_avatar_pool(string $type = 'majice'): array {
    $type = ($type === 'boxers' || $type === 'bokserice') ? 'bokserice' : 'majice';
