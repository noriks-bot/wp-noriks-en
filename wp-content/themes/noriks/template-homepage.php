...
@media (max-width: 640px) {
  ...
  <div class="collections__header">
    ...
    <a class="collections__cta" href="/shop">
  ...
  <div class="collections__grid">
    <!-- Card 1 -->
    <a class="collection-card" href="/product-category/t-shirts/">
    ...
    <!-- Card 2 -->
    <a class="collection-card" href="/product-category/boxers/">
      <div class="collection-card__media">
        <img
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="/product-category/sets/">
      <div class="collection-card__media">
        <img
...
Best value per package.
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="/shop/?yith_wcan=1&product_cat=starter-pack&orderby=popularity">
      <div class="collection-card__media">
        <img
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          ...
          <p class="collection-card__desc">
Try NORIKS at a better entry price.
