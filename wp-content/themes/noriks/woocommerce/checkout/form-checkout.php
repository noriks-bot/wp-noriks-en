  ...
  <div class="checkout-coupon-inline">
    <p class="form-row cci-form-row-first">
      ...
      <input
        ...
        id="cci-coupon-input"
        class="input-text"
        placeholder="<?php esc_attr_e( 'Discount code or gift card', 'woocommerce' ); ?>"
      />
    </p>
...
(function($){
  ...
  function successHtml(){
    return '<div class="woocommerce-message" role="alert">Coupon applied.</div>';
  }
  function errorHtml(){
    return '<ul class="woocommerce-error" role="alert"><li>Enter a valid discount or gift card code.</li></ul>';
  }
  ...
  $(ensureNoticeTarget);
        	...
        	<div id="order_review" class="woocommerce-checkout-review-order">
        	    ...
        	    <h3 class="checkout-section-title"><?php echo get_field("checkout_option_order_review_text","options"); ?></h3>
                 ...
                 <div class="inline-coupon-notices dekstopni"></div>
                   ...
                   <script>
                    (function($){
                      ...
                      function successHtml(){ return '<div class="woocommerce-message" role="alert">Coupon applied.</div>'; }
                      function errorHtml(){   return '<ul class="woocommerce-error" role="alert"><li>Enter a valid discount or gift card code.</li></ul>'; }
