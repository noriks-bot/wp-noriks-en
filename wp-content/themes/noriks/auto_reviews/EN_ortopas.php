<?php
// Review pool for the orthopedic back belt (ortopas).
// Real German reviews translated to English.
$auto_reviews_en = array(
    ...
    array("name" => "Craig R.", "text" => "I used to do a lot of sport – the belt complements my training perfectly. After long shifts there is no more pain. The build is very robust, the fit excellent."),
    array("name" => "Simon V.", "text" => "At first I looked at the price, now it seems justified: no more constant physiotherapy appointments. The material feels high quality."),
    array("name" => "Martin G.", "text" => "After several procedures I was looking for something extra – Noriks brings relief and better sleep. No miracles, but the relief is visible."),
    ...
    array("name" => "Dale C.", "text" => "The purchase paid off – after two weeks less pain, money well spent. I recommend it to anyone with sciatica problems."),
    array("name" => "Tim R.", "text" => "An improvement after just a few days."),
    array("name" => "Ivan B.", "text" => "You feel the relief straight away. Comfortable to wear."),
    array("name" => "Steven M.", "text" => "It works, but it could be a little more comfortable."),
);
