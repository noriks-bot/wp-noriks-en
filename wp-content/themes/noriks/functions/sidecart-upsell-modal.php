...
function noriks_ajax_add_to_cart() {
    ...
    if ($cart_item_key) {
        ...
        $msg = !empty($notices) ? strip_tags($notices[0]['notice'] ?? $notices[0]) : 'Error adding product';
        wc_clear_notices();
    ...
    <div id="noriks-upsell-modal" class="noriks-modal-overlay" style="display:none;">
        <div class="noriks-modal">
            ...
            <div class="noriks-modal-body">
                ...
                <div id="noriks-modal-error" class="noriks-modal-error" style="display:none;">Select all options</div>
        ...
        $(document).on('click', '#noriks-modal-add', function() {
            ...
            $.post(woocommerce_params.ajax_url, data, function(res) {
                ...
                if (res.success !== false && res.fragments) {
                    ...
                    var msg = (res.data && res.data.message) ? res.data.message : 'Error adding product';
                ...
                $btn.removeClass('adding').text('ADD TO CART');
                $('#noriks-modal-error').text('Error adding product').show();
            });
        });
