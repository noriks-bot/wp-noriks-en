...
<style>
 ...
 <section class=" features2" aria-label="Prednosti">
  ...
  <img src="/en/wp-content/themes/noriks/img/cod_icon_.png" alt="Customer Support Icon" class="feature__icon info-icon">
...
<div class="shipping-box">
  ...
  <p class="shipping-sub">
    Order within <span id="midnight-countdown" class="countdown"></span>
  </p>
</div>
...
<br>
     ...
     <div class="accordion-item">
      ...
      <div class="accordion-content">
          ...
          <img src="https://noriks.com/en/wp-content/uploads/2026/01/boxers_size_GR.png">
        ...
        <?php elseif(  $is_carape ): ?>
                  ...
                  <img src="https://noriks.com/en/wp-content/uploads/2026/01/Nogavice_tabela_velikosti_GR.png">
                  
    <?php elseif(  $is_mixed_bundle ): ?>
    
     <img src="https://noriks.com/en/wp-content/uploads/2025/09/noriks_tablica_gr.jpg">
